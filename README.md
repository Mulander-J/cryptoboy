...
- **厄运时刻（Fate Night）**：噩梦 / 无尽默认开启；三锁一悬时进入收官定色（默认节拍，自由美式主题为左轮；试炼可选手动开关）
- **自定义试炼**：难度预设、颜色数、重复、提示、限时、预设答案（本地双人）、厄运时刻等可配
...
| [`src/data`](./src/data/README.md) | 关卡曲线、自定义试炼、localStorage 进度 |
