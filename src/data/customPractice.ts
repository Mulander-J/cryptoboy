import { sanitizeFateCaseDifficulty, type FateCaseDifficultyTier } from '@/domain/fateCase'
...
export function sanitizeOptions(raw: Partial<CustomPracticeOptions> | undefined): CustomPracticeOptions {
  ...
  const fateCaseDifficulty = sanitizeFateCaseDifficulty(base.fateCaseDifficulty)
...
export function customOptionsToLevelConfig(opts: CustomPracticeOptions): LevelConfig {
  ...
  return {
    ...
    fateCaseDifficulty: clean.fateCaseDifficulty,
