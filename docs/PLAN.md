...
| P5-2 完整设置 | ⏳ | 仅音效；缺确认提交、色盲图案、进度重置 |
| P5-4/5 响应式与 a11y | ⏳ | 基础居中；未系统做 |
| 联网 / Wasm / 上架 | ❌ | 暂时不做 |
...
1. 完整设置页（色盲 / 确认提交 / 重置进度）  
2. P4.9 页面路由（结构规范化；可与 1 穿插）  
3. P4.10 Pages `404.html` SPA 回退（随路由落地）  
4. a11y 与小屏顶栏避让  
5. （远期）联机 Duo
